...
function createData(no_responsable, apellido, no_req, inicio, fin, tiempo) {
...
export default function Weeks_table({data}) {
    ...
    for(let i = 0; i < data.length; i++){
      rows[i] = createData(Object.values(data)[i].no_responsable, Object.values(data)[i].apellido, Object.values(data)[i].no_req,
                          Object.values(data)[i].inicio, Object.values(data)[i].fin, Object.values(data)[i].tiempo);
    }
